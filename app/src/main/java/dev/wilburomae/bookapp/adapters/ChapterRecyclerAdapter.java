...
public class ChapterRecyclerAdapter extends RecyclerView.Adapter<ChapterRecyclerAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            super(view);
            cardView = (CardView) view.findViewById(R.id.main_recycler_card);
            txtTitle = (TextView) view.findViewById(R.id.main_recycler_card_title);
            txtIntro = (TextView) view.findViewById(R.id.main_recycler_card_intro);
            cardView.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    Context context = v.getContext();
                    Intent nextActivity = new Intent(context, ReaderActivity.class);
                    nextActivity.putExtra("POSITION", (int) cardView.getTag());
